...
if __name__ == '__main__':
    ...
    # settings for eDCNN-zeropadding
    num_layers = 4
    filter_size = 5
    ...
    # add logs
    fig_save_path = './newlogs_noisydata/eDCNN-zeropadding-smoothDim100/'
    ...
    file_name = (
        ...
        f'_epoch={num_epoch}_b={bias_value}_lr={learning_rate}_noiseStd={noise_std}')
